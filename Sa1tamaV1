...
class Sa1tamaV1:
    ...
    def menu(self):
        os.system(f"cls & title Sa1tamaV1 Nuker ^| Authenticated as: {__client__.user.name}#{__client__.user.discriminator}")
        print(Sa1tamaV1_art + options + "\n")
        ans = input("{}({}Sa1tamaV1{}) Option{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m")) 
        
        if ans in ["1", "01"]:
            scrape = input("{}({}Sa1tamaV1{}) Fetch IDs [Y/N]{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            if scrape.lower() == "y":
                try:
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Banned {}/{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.banned), len(members)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Kicked {}/{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.kicked), len(members)))
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["3", "03"]:
            days = int(input("{}({}Sa1tamaV1{}) Days{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m")))
            self.execute_prune(guildid, days, token)
            time.sleep(1.5)
            self.menu()
            
        elif ans in ["4", "04"]:
            type = input("{}({}Sa1tamaV1{}) Channels Type ['t', 'v']{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            type = 2 if type == "v" else 0
            amount = int(input("{}({}Sa1tamaV1{}) Amount{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m")))
            self.channels.clear()
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Created {}/{} channels".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.channels), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Created {}/{} roles".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.roles), amount))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Deleted {}/{} channels".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.channels), len(channels)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Deleted {}/{} roles".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.roles), len(roles)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Deleted {}/{} emojis".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.emojis), len(emojis)))
            time.sleep(1.5)
            self.menu()
            ...
            time.sleep(3)
            print("{}({}Sa1tamaV1{}) Spammed {}/{} messages".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", len(self.messages), amount))
            time.sleep(1.5)
            self.menu()
            
        elif ans == "10":
            try:
                response = self.session.get("https://discord.gg/sp1it")
                check_version = response.headers.get('location').split('/')[7].split('v')[1]
                if VERSION != check_version:
                    print("{}({}Sa1tamaV1{}) You're using an outdated version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
                    webbrowser.open(f"https://discord.gg/sp1it{check_version}")
                else:
                    print("{}({}Sa1tamaV1{}) You're using the current version!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            except:
                print("{}({}Sa1tamaV1{}) Couldn't reach the releases!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            ...
            print("- Sa1tamaV1 Nuker on top!\n- Press enter to return.")
            input("")
            self.menu()
        
        elif ans == "12":
            print("{}({}Sa1tamaV1{}) Thanks for using Sa1tamaV1 Nuker!".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
            time.sleep(1.5)
            os._exit(0)
...
@__client__.event
async def on_ready():
    print("{}({}Sa1tamaV1{}) Authenticated as{}: {}{}".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", f"{__client__.user.name}#{__client__.user.discriminator}"))
    time.sleep(1.5)
    Sa1tamaV1().menu()
...
if __name__ == "__main__":
    try:
        os.system("title Sa1tamaV1 Nuker ^| Authentication & mode con: cols=95 lines=25")
        guildid = input("{}({}Sa1tamaV1{}) Guild ID{}:{} ".format("\x1b[0m", "\x1b[38;5;21m", "\x1b[0m", "\x1b[38;5;21m", "\x1b[0m"))
